...
INPUT_GLOB = '/media/gpaps/My Passport/CVRL-GeorgeP/_/annotations_v2_10_2025/sar/ships/images/*.tif'  # supports spaces; keep quotes
OUT_ROOT   = '/media/gpaps/My Passport/CVRL-GeorgeP/_/annotations_v2_10_2025/sar/ships/images/_outputs'    # where to write per-image folders
# OUT_ROOT   = './sar_outputs'    # where to write per-image folders
TILE       = 5000               # tile size (e.g., 800 or 1000)
STRIDE     = 5000               # stride (same as TILE for no overlap)
SMOOTH     = 'mean3'             # 'none','mean3','mean5','median3','gauss1','gauss2' (display only)
ON_ERROR   = 'skip'             # 'skip' or 'fill' tiles that fail to read
THUMB_MAX  = 4048               # quicklook longest side in pixels
# ============================
