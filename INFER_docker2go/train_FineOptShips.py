...
def setup_and_train(output_dir, num_classes, lr=0.0001, roi_batch=512, nms=0.5, score=0.5,  backbone="r50"):
    ...
    # Input
    cfg.INPUT.MIN_SIZE_TRAIN = [512, 768, 1024, 1280]
    ...
    # Finetune params.
    cfg.MODEL.ANCHOR_GENERATOR.SIZES = [[8, 16],[16, 32],[32, 64],[64, 128],[128, 256],]
    cfg.MODEL.ANCHOR_GENERATOR.ASPECT_RATIOS = [[0.33, 0.5, 1.0, 2.0, 3.0]] * 5

    cfg.MODEL.RPN.NMS_THRESH = 0.6
    cfg.MODEL.RPN.PRE_NMS_TOPK_TRAIN = 4000   # more proposals to not drop tiny ships
...
##
    ...
    cfg.MODEL.WEIGHTS = "/media/gpaps/My Passport/CVRL-GeorgeP/Trained_models/ShipOpt/run_1/Optical_sweep_lr0.00015_b512_s0.5_nms0.4/model_best.pth"
...
if __name__ == "__main__":
    ...
    output_dir = f"/media/gpaps/My Passport/CVRL-GeorgeP/Trained_models/ShipOpt/run_1/fine_tune_lr15_b512_/Optical_sweep_{args.name}"
